...
// JS code for the video popup on load site.
$( document ).ready(function() {
    if (!sessionStorage.getItem('videoPopupDisplayed')) {
    var screenWidth = $(window).width();
    var screenHeight = $(window).height();
    var videoPopup = $('#video-popup');
    var myVideo = $('#my-video-d')[0];
  ...
  myVideo.addEventListener('ended', function() {
    ...
    $('#my-video-d')[0].play();
    sessionStorage.setItem('videoPopupDisplayed', true);
  }
});